 ...
 *
 * Shares the scroll dissolve with the backdrop and the stickers, so the hero
 * comes apart as one event.
 */
...
void main() {
  ...
  float alpha = dotMatrixMask(gl_FragCoord.xy / uPixelRatio, uDissolve, uDotPx);
