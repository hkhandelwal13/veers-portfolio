 ...
 *
 * Its ground is the shared dot-matrix (see DotMatrix), grown out of the Menu
 * button's corner and retracted back into it on close — the same wipe the
 * loader and the route transition use.
 */
export function MobileMenu({
  ...
  return (
    ...
    >
      <DotMatrix covered={open} origin="top-right" retract className={styles.sheet} />
